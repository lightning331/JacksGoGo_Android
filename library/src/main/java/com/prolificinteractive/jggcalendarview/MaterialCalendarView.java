package com.prolificinteractive.jggcalendarview;
...
import com.prolificinteractive.jggcalendarview.format.ArrayWeekDayFormatter;
import com.prolificinteractive.jggcalendarview.format.DateFormatTitleFormatter;
import com.prolificinteractive.jggcalendarview.format.DayFormatter;
import com.prolificinteractive.jggcalendarview.format.MonthArrayTitleFormatter;
import com.prolificinteractive.jggcalendarview.format.TitleFormatter;
import com.prolificinteractive.jggcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain com.prolificinteractive.jggcalendarview.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.prolificinteractive.jggcalendarview.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.prolificinteractive.jggcalendarview.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.prolificinteractive.jggcalendarview.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.prolificinteractive.jggcalendarview.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.prolificinteractive.jggcalendarview.format.TitleFormatter)
     */
