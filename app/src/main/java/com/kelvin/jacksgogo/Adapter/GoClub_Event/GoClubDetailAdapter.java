...
import com.kelvin.jacksgogo.CustomView.RecyclerViewCell.GoClub_Events.PastEventRecyclerView;
...
public class GoClubDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            ...
            PastEventRecyclerView eventViewHolder = new PastEventRecyclerView(pastEventView, mContext);
