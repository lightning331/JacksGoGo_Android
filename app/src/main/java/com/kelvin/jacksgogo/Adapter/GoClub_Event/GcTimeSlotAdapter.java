...
/**
 * Created by storm2 on 4/19/2018.
 */

public class GcTimeSlotAdapter extends RecyclerView.Adapter {

    private Context mContext;
    private List<JGGTimeSlotModel> mList;

    private PostServiceTimeSlotAdapter.OnPostServiceTimeSlotItemClickListener listener;

    public interface OnPostServiceTimeSlotItemClickListener {
        void onPostServiceTimeSlotItemClick(boolean isDelete, int position);
    }

    public void setOnItemClickListener(PostServiceTimeSlotAdapter.OnPostServiceTimeSlotItemClickListener listener) {
        this.listener = listener;
    }


    public GcTimeSlotAdapter(Context context, List<JGGTimeSlotModel> list) {
        mContext = context;
        mList = list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        GcTimeSlotViewHolder holder = new GcTimeSlotViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        GcTimeSlotViewHolder cell = (GcTimeSlotViewHolder) holder;
    ...
    class GcTimeSlotViewHolder extends RecyclerView.ViewHolder {

        public TextView lblTime;
        public ImageView btnEdit;
        public ImageView btnDelete;

        public GcTimeSlotViewHolder(View itemView) {
            super(itemView);
