...
public class PackageServiceTimeSlotAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private ArrayList<JGGTimeSlotModel> mTimeSlots = new ArrayList<>();

    private OnPackageServiceTimeSlotItemClickListener listener;

    public interface OnPackageServiceTimeSlotItemClickListener {
        void onPackageServiceTimeSlotClick(boolean isDelete, int position);
    }

    public void setOnItemClickListener(OnPackageServiceTimeSlotItemClickListener listener) {
        this.listener = listener;
    }

    public PackageServiceTimeSlotAdapter(Context context, ArrayList<JGGTimeSlotModel> list) {
        mContext = context;
        mTimeSlots = list;
    }
        ...
        if (holder instanceof EditJobTimeSlotsCell) {
            ...
            cell.btnSlots.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    listener.onPackageServiceTimeSlotClick(false, position);
                }
            });
        }
    }
