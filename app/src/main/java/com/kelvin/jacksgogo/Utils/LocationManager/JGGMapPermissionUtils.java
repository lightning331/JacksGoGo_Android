package com.kelvin.jacksgogo.Utils.LocationManager;
...
/**
 * Created by PUMA on 3/21/2018.
 */

public class JGGMapPermissionUtils {
    ...
    public JGGMapPermissionUtils(Context context)
    {
    ...
    public JGGMapPermissionUtils(Context context, PermissionResultCallback callback)
    {
        this.context=context;
        this.current_activity= (Activity) context;
